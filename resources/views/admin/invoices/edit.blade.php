...
<Section class="section">
 ...
 <form action="{{url('admin/invoices/edit/'.$EditRecord->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{ $EditRecord->net_total}}" name="net_total" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label">Invoices Date<span style="color: red;">*</span></label>
                            <div class="col-sm-10">
                                <input type="date" value="{{$EditRecord->invoices_date}}" name="invoices_date" class="form-control" required>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" value="{{$EditRecord->total_discount}}" name="total_discount" class="form-control" required>
                            </div>
                        </div>
